...
func (wq *WebsiteQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (wq *WebsiteQuery) FirstIDX(ctx context.Context) int64 {
...
func (wq *WebsiteQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (wq *WebsiteQuery) OnlyIDX(ctx context.Context) int64 {
...
func (wq *WebsiteQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (wq *WebsiteQuery) IDsX(ctx context.Context) []int64 {
	ids, err := wq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (wq *WebsiteQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(website.Table, website.Columns, sqlgraph.NewFieldSpec(website.FieldID, field.TypeInt64))
	_spec.From = wq.sql
