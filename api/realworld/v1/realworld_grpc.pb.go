...
func (c *realWorldClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/realoworld.v1.RealWorld/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *realWorldClient) WebSiteList(ctx context.Context, in *WebsiteRequest, opts ...grpc.CallOption) (*WebsiteReply, error) {
	...
	err := c.cc.Invoke(ctx, "/realoworld.v1.RealWorld/WebSiteList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RealWorld_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realoworld.v1.RealWorld/SayHello",
	}
...
func _RealWorld_WebSiteList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realoworld.v1.RealWorld/WebSiteList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
